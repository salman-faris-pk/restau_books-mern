...
const SearchBar = () => {
  ...
  return (
    ...
    className="-mt-8 p-2 md:p-3 bg-orange-400 rounded shadow-md grid grid-cols-2 lg:grid-cols-3 2xl:grid-cols-5 items-center gap-4"
    >
    ...
    <div>
      <DatePicker
        ...
        wrapperClassName="w-full md:min-w-full"
      />
    </div>
    <div>
      <DatePicker

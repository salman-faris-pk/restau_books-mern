  ...
  return (
    <div className="space-y-3">
       <div className="flex items-center justify-between px-2 md:px-0">
        ...
        <span className="cursor-pointer border-2 bg-slate-100 p-1 transition-transform rounded-full hover:scale-105" onClick={()=> refetch()}><FcRefresh size={22} className={`${isFetching ? "text-blue-300" : ""}`}/></span>
        </div>
